...
public class OverHeatSpell extends ContinousUsageSpell {
    ...
    public OverHeatSpell(int manaCost, SpellSchool school, int chargeTime, String name, int cooldown, Identifier texture, int useTime, boolean needsHeld, int overtimecost) {
