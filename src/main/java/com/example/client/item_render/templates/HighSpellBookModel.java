...
public class HighSpellBookModel extends GeoModel<SpellFocus> {

    @Override
    public Identifier getModelResource(SpellFocus animatable) {
        return new Identifier(N3rdyR0b1nsSpellEngine.MOD_ID, "geo/high_spellbook.geo.json");
    }

    @Override
    public Identifier getTextureResource(SpellFocus animatable) {
        return new Identifier(N3rdyR0b1nsSpellEngine.MOD_ID, "textures/item/high_spellbook.png");
    }
